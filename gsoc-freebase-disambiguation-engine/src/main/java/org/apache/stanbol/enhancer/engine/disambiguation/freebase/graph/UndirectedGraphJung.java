...
/**
 * <p>Custom implementation of GraphJung which allows the graph to be undirected, i.e, not taking into account the direction of the edges</p>
 * 
...
public class UndirectedGraphJung extends GraphJung<Graph>
{
     ...
     * @param graph The {@code Graph} object to be used as raw graph for JUNG implementation
     */
    ...
    /**
     * <p>Get the out edges for a vertex</p>
     * <p>Returns the incoming and outgoing edges for the vertex</p>
     * 
    ...
    /**
     * <p>Get the in edges for a vertex</p>
     * <p>Returns the incoming and outgoing edges for the vertex</p>
     * 
     * @param vertex The vertex
     * @return The {@code Collection<Edge>} of edges
    ...
    /**
     * <p>Gets all the edges for a vertex, both incoming and outgoing edges</p>
     * @param vertex The vertex
     * @return The {@code Collection<Edge>} of edges
     * 
     */
